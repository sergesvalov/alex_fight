...
5. **Техническое помещение**: Находится в правом конце горизонтального коридора. Его ширина вместе с шириной Лифта математически равна ширине одиночного номера (410).
...
Z (North)
  +-----------------------+---------------+-------+-------+
  |                       |               |       |       |
  |                       |  NORTH STAIRS | ELEV  | EMPTY |
  |          401          |               |       |       |
  |         (DBL)         +-------D-------+---D---+-------+
  |                       |                               |
  | [Size = 2 x H_corr]   D      HORIZONTAL CORRIDOR      D MAINT
  |                       |          "LEVEL 4"            |
  +-----------------------+               +---------------+
  |                       |               |               |
