...
3. **Северная лестница и Лифт**: Занимают 1 модуль по высоте (5.0м).
4. **Горизонтальный коридор**: Занимает 1 модуль по высоте (5.0м).
5. **Техническое помещение**: Занимает 2 модуля по высоте (10.0м) — зеркально отражает номер 401.
6. **Южная лестница**: Занимает 1 модуль по высоте (5.0м). Она занимает правую часть здания (от левой стены коридора до правой внешней стены), закрывая коридор.
...
Z (North)
  ...
  |          401          +-------D-------+---D---+     ROOM      |
  |         (DBL)         |  HORIZ CORRIDOR       |               |
  |      (Z = 10.0m)      |  (Z = 5.0m)           D  (Z = 10.0m)  |
  +-----------------------+                       +---------------+
  |                       |                       |      410      |
  |                       D                       D  (SNG)(5.0m)  |
  |          402          |                       +---------------+
  |         (DBL)         |                       |      411      |
  |      (Z = 10.0m)      |       VERTICAL        D  (SNG)(5.0m)  |
  +-----------------------+       CORRIDOR        +---------------+
  |                       |      (Z = 45.0m)      |      412      |
  |                       D                       D  (SNG)(5.0m)  |
  |          403          |                       +---------------+
