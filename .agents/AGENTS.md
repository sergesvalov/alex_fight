...
7. **Номер 408**: Расположен строго у южной стены. Его верхняя половина (5.0м) граничит с вертикальным коридором, а нижняя половина (5.0м) граничит с самой коробкой Южной лестницы. Вход на лестницу расположен строго по центру коридора, между номером 408 и номером 421.
