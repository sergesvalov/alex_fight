...
func _generate_floor(f_num: int, parent: Node3D, is_main: bool) -> void:
    ...
    _create_csg_box(parent, "CorridorFloor", Vector3(0, 0, corridor_center_z), Vector3(corridor_width, 0.5, corridor_length), true)
    _create_csg_box(parent, "CorridorCeiling", Vector3(0, corridor_height, corridor_center_z), Vector3(corridor_width, 0.5, corridor_length), true)
