...
func _init():
	...
	pack.pack(root)
	ResourceSaver.save(pack, "res://scenes/levels/hotel_siberia/blocks/north_stairs.tscn")
	print("North Stairs generated!")
	quit()
